...
def sort_endpoint():
    ...
    if mode == 'local':
        ...
        split_data_list = split_data(data, 4)

        # Define remote machines URLs
        machine1_url = "http://10.26.13.243:5000/sort"
        machine2_url = "http://10.26.12.20:5000/sort"
        machine3_url = "http://10.26.13.155:5000/sort"
        ...
        sorted_part3, remote_duration2 = send_to_machine(split_data_list[2], machine2_url)
        sorted_part4, remote_duration3 = send_to_machine(split_data_list[3], machine3_url)

        # Merge the results
        final_sorted_data = merge(sorted_part1, sorted_part2,sorted_part3,sorted_part4)
        ...
        return jsonify({
            ...
            'remote_execution_time_2': remote_duration2,
            'remote_execution_time_3': remote_duration3,
            'total_execution_time': total_duration
        })
    else:
...
if __name__ == '__main__':
    app.run(host='10.26.15.151', port=5000)
